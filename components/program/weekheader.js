...
const WeekHeader = ({weekDetail}) => {
  return (
    <div className={`bg-gradient-to-r from-[#71e794] to-[#f4f2ff] rounded-lg p-8 flex flex-row-reverse items-center justify-between space-x-8`}
    ...
    >
      ...
      <div className="text-white">
        <div className="text-lg font-semibold  bg-slate-100 w-fit rounded-full px-2 " style={{color: weekDetail.color}} >Week {weekDetail.week}</div>
